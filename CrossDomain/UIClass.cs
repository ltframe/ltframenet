...
namespace Canvas
{
    public class UIClass
    {
        ...
        public UIClass(string path)
        {
            ...
            ltf = new LTFrameNetClass("LTFrame-crossdomain","CrossDomain", IntPtr.Zero, Win32DataType.WS_POPUP | Win32DataType.WS_VISIBLE, rect.Left, rect.Top, ww, wh, IntPtr.Zero);
