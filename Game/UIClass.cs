...
namespace Canvas
{
    public class UIClass
    {
        ...
        public UIClass()
        {
            ...
            ltf = new LTFrameNetClass("LTFrame-Game","Game", IntPtr.Zero, Win32DataType.WS_POPUP | Win32DataType.WS_VISIBLE, rect.Left, rect.Top, ww, wh, IntPtr.Zero);
            ...
            ltf.loadFile(Lib.GetAppPath + @"./template/game/index.html");
